...
@FrameworkComponent
public class TenantTestEntityServiceImpl extends BaseEntityServiceImpl<TenantTestEntity> implements TenantTestEntityApi {

    @Inject
    private TenantTestEntitySystemApi tenantTestEntitySystemApi;

    @Inject
    private ComponentRegistry waterComponentRegistry;

    public TenantTestEntityServiceImpl() {
        super(TenantTestEntity.class);
    }

    @Override
    protected BaseEntitySystemApi<TenantTestEntity> getSystemService() {
        return tenantTestEntitySystemApi;
    }

    public void setTenantTestEntitySystemApi(TenantTestEntitySystemApi tenantTestEntitySystemApi) {
        this.tenantTestEntitySystemApi = tenantTestEntitySystemApi;
    }
